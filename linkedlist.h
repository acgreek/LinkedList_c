...
static ListNode_t * ListFind(ListNode_t * listp,ListNode_t * nodep,  ListCompareFunc_t func, void *datap) {
	ListNode_t *cur_nodep =listp->nextp;
	while (listp != cur_nodep ) {
		if (0 ==func (nodep, cur_nodep,  datap)) {
			return cur_nodep;
...
static ListNode_t *ListFind(ListNode_t * listp,ListNode_t * nodep,  ListCompareFunc_t func, void *datap) UNUSED;
